...
INSERT INTO AREA (nombre,n_colaboradores,horario) values ('Coordinación General',0,'1-10', 'San Joaquin');
INSERT INTO AREA (nombre,n_colaboradores,horario) values ('Túnel',0,'1-2', 'San Joaquin');
INSERT INTO AREA (nombre,n_colaboradores,horario) values ('Dinámicas',0,'3-4', 'San Joaquin');
INSERT INTO AREA (nombre,n_colaboradores,horario) values ('Concursos',0,'3-4', 'San Joaquin');
INSERT INTO AREA (nombre,n_colaboradores,horario) values ('Alimentación',0,'5-8','Vitacura');
INSERT INTO AREA (nombre,n_colaboradores,horario) values ('Registro Visual',0,'1-10','Vitacura');
INSERT INTO AREA (nombre,n_colaboradores,horario) values ('Audio',0,'5-10','Vitacura');
